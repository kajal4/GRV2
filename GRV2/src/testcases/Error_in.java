...
public class Error_in extends Browser
{

	@ Test (enabled=false)//done
	public void GRV2_TS024 () throws InterruptedException, SQLException
	{
...
//		JOptionPane.showMessageDialog(null, "wait for some time JS is getting load");
	...
	@Test  // impact on age is no
	public void GRV2_TS026 () throws InterruptedException, SQLException
	{
		base.TestConnectivity con = new base.TestConnectivity();
		con.setup();
		JavascriptExecutor jse = (JavascriptExecutor)dr;
		...
		sc.incorrect_info();
		sc.correct_info();
		sc.policy_issue_date1("31","Jan","2013");
		sc.cd("Mistake in Date of Commencement (DOC).");
		sc.rca_comment("Mistake in Date of Commencement (DOC)");
		sc.Reason();
		sc.IRDAProb("scrutiny IRDA comments...");
	...
	@ Test 
	public void GRV2_TS028 () throws InterruptedException, SQLException
	{
		base.TestConnectivity con = new base.TestConnectivity();
		con.setup();
	    login lg = new login (dr);
		...
		nb.window_handling(dr);
		nb.desicion_search_box("New Number Taken");
//		JOptionPane.showMessageDialog(null,"wait for sometime JS is getting load");
		nb.save();
		Thread.sleep(2000);
		lg.logout();
		abc= con.querry("select loginid from az_user where UserID=(select CurrentOwnerID from cases where caseid="+case_id+")");
	...
	@ Test 
	public void GRV2_TS029 () throws InterruptedException, SQLException
	{
		base.TestConnectivity con = new base.TestConnectivity();
		con.setup();
	    login lg = new login (dr);
	...
	@Test (enabled=false)
	public void GRV2_TS027 () throws InterruptedException, SQLException
	{
		base.TestConnectivity con = new base.TestConnectivity();
		con.setup();
		JavascriptExecutor jse = (JavascriptExecutor)dr;
	...
	@ Test 
	public void GRV2_TS030 () throws InterruptedException, SQLException
	{
		base.TestConnectivity con = new base.TestConnectivity();
		con.setup();
		login lg = new login (dr);
	...
	@ Test 
	public void GRV2_TS056 () throws InterruptedException, SQLException
	{
		base.TestConnectivity con = new base.TestConnectivity();
		con.setup();
	    login lg = new login (dr);
...
//********************************************************************
	...
	@Test  // impact on age is no
	public void GRV2_TS058 () throws InterruptedException, SQLException
	{
		base.TestConnectivity con = new base.TestConnectivity();
		con.setup();
		JavascriptExecutor jse = (JavascriptExecutor)dr;
	...
	@Test  // working
	public void GRV2_TS059 () throws InterruptedException, SQLException
	{
		base.TestConnectivity con = new base.TestConnectivity();
		con.setup();
		JavascriptExecutor jse = (JavascriptExecutor)dr;
	...
	@ Test  // working
	public void GRV2_TS060 () throws InterruptedException, SQLException
	{
		base.TestConnectivity con = new base.TestConnectivity();
		con.setup();
	    login lg = new login (dr);
...
//		JOptionPane.showMessageDialog(null,"wait for sometime JS is getting load");
	...
	@ Test 
	public void GRV2_TS061 () throws InterruptedException, SQLException
	{
		base.TestConnectivity con = new base.TestConnectivity();
		con.setup();
	    login lg = new login (dr);
	...
	@ Test 
	public void GRV2_TS062 () throws InterruptedException, SQLException
	{
		base.TestConnectivity con = new base.TestConnectivity();
		con.setup();
		login lg = new login (dr);
